...
#' 
mi_fam_d_hel <- dist.ldc(mc_arecc, "hellinger", silent = T)
...
#' 
mi_fam_jac <- vegdist(mc_arecc, method = 'jac', binary = T)
...
#' 
mi_fam_sor <- vegdist(mc_arecc, method = 'bray', binary = T)
mi_fam_sor %>% tidy
