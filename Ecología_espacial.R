...
grid.arrange(do.call('arrangeGrob', c(lisamaps_mifam[1:9], nrow = 3)), lisamaps_mifam$leyenda, heights=c(1.1, 0.1), nrow = 2)
#grid.arrange(do.call('arrangeGrob', c(lisamaps_mifam[10:16], nrow = 3)), lisamaps_mifam$leyenda, heights=c(1.1, 0.1), nrow = 2)
#' 
...
grid.arrange(do.call('arrangeGrob', c(lisamaps_mifam_sintendencia[1:9], nrow = 3)), lisamaps_mifam_sintendencia$leyenda, heights=c(1.1, 0.1), nrow = 2)
#grid.arrange(do.call('arrangeGrob', c(lisamaps_mifam_sintendencia[10:16], nrow = 3)), lisamaps_mifam_sintendencia$leyenda, heights=c(1.1, 0.1), nrow = 2)